<?php
/*
    Plugin Name: CMS2CMS Movable to WordPress migration
    Plugin URI: http://www.cms2cms.com
    Description: Migrate your website content from Movable to WordPress easily and automatedly in just a few simple steps.
    Version: 1.0.1
    Author: MagneticOne
