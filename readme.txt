=== CMS2CMS: Movable Type to WordPress Migrator   ===
Contributors: cms2cms
Tags: Movable Type to WordPress, Movable Type to WordPress migration, convert Movable Type to WordPress, migrate Movable Type to WordPress, images, plugin
...
If you wish to migrate your current Movable Type to WordPress - CMS2CMS Migration Plugin can help in a few easy-to-do steps.
...
Find more info about migration here: http://www.cms2cms.com/supported-cms/movable-type-to-wordpress-migration/?utm_source=Movable-Type&utm_medium=Link&utm_campaign=WordPress_plugins
...
1. Go to Admin -> Plugins, find “Movable Type to WordPress Migration” and click Activate.
